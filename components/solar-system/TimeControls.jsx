...
const CONTROLS = [
  {
    ...
    modal: {
      ...
      body: [
        `What you're looking at right now — the planets drifting in silence, the Sun burning at the centre — has all stopped. Not slowed. Stopped. Every photon that left the Sun 8 minutes ago is frozen mid-journey. Every heartbeat of every animal on Earth is suspended between one beat and the next. The oceans are glassy, motionless. Wind does not move. Dust does not fall.`,
  ...
  },
  {
    ...
    modal: {
      ...
      body: [
        ...
        `Even the Sun's position in the galaxy matters. We orbit at roughly 26,000 light-years from the galactic centre — far enough to avoid the dense radiation storms of the core, close enough to have accumulated the heavy elements (iron, carbon, oxygen) that complex chemistry requires. Stars near the core are blasted with gamma radiation. Stars at the outer edge lack the metals life needs. We are in the Goldilocks lane of the galaxy itself.`,
        `All of this — the Moon's size, Jupiter's position, Earth's distance from the Sun, our position in the Milky Way — could have been different. The probability of all of it aligning is staggeringly small. Which means that this moment, this exact speed, this exact configuration is either an extraordinary accident — or we're missing something profound about why the universe produces life.`,
      ],
  ...
  },
  {
    ...
    modal: {
      ...
      body: [
        ...
        `At this timescale, the Moon is slowly drifting away from Earth at 3.8 cm per year. In 600 million years it will be too far away to cause total solar eclipses. In 1–2 billion years, tidal forces will have slowed Earth's rotation to a 30-hour day. The tides will be weaker. Ocean circulation will change. Life will adapt — as it always has — or it won't.`,
      ],
